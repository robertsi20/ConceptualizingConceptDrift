...
# def init_I(m, num_data, labels, num_classes, num_data_class):
...
#
#             num_points_in_class = num_data_class[i]
#
...
#                 num_points_in_class = num_data_class[label]
#                 matrix[start_row_index:end_row_index, current_col_index:current_col_index + num_points_in_class] = 0
#                 current_col_index += num_points_in_class
#
#             current_col_index += num_data_class[label]
#
#     return matrix
...
class RSSNMF(NMF):
    ...
    def __init__(self, n_components=None, p=None, mu=None, normalize=True, init=None, solver='mu', beta_loss='frobenius',
